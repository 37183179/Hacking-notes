...
## Solution
+ I enter this command in the terminal: nc jupiter.challenges.picoctf.org 5726
+ The connection gives me encrypted text
+ The text uses the vigenere cipher
+ I search for a decoder on the internet
+ I copy and paste the cipher text into this tool [Vigenère Solver](https://www.guballa.de/vigenere-solver)
+ The flag is inside the decrypted text
